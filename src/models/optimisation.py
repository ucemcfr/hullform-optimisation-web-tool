...
def deap_evolve(loLWL, loB, loT, loVolDisp, loCwp, hiLWL, hiB, hiT, hiVolDisp, hiCwp, LCB, V, popsize, maxgen):
    ...
    for gen in range(maxgen):
        ...
        invalid_ind = [ind for ind in offspring if not ind.fitness.valid] # TODO I don't get what this is doing, why am I evaluating the invalid ones? -- NB this has been canged from "if not" to "if"
